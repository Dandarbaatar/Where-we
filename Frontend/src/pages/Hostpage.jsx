...
function Hostpage() {
  ...
  return (
    <div className="host_container_dad">
      <Header />
      <div className="host_container">
        <div className="host_banner">
          <div className="host_banner_inside">
            ...
            <div className="host_butt">
              <button onClick={handlesubs} className="host_button">
                Lets Get Started
              </button>
            </div>
          </div>
        ...
        <div className="host_middle">
            ...
            <div className="host_row">
              ...
              <div className="host_paraghs">
                ...
                <div className="host_paragh">
                  At vero eos et accusamus et iusto odio dignissimos ducimus qui
                  blanditiis praesentium voluptatum deleniti atque corrupti quos
                  dolores et quas molestias.At vero eos et accusamus et iusto
          ...
          <div className="host_middle_footer_container">
            <div className="Try_host">Hosting Tips & Guides</div>
