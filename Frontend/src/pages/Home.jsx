    ...
    <div className="Home">
      ...
      <div className="homePage2">
        ...
        <div className="homePage2Content2Cards">
          {data.map((e) => {
            return (
              <div onClick={() => (window.location.href = `detail?${e._id}`)}>
                <div
                  className="homeCard"
                  style={{
                    backgroundImage: `url(${e.image[0].zurag0})`,
                ...
                >
                  ...
                  <div className="homeCardContent1">
                    <div className="homeCardContent">
                      ...
                      <div className="homeCardContentText2">
        ...
        <div className="homePage5cards">
          {data.map((e) => {
            return (
              <div
                className="homeCard2"
                onClick={() => (window.location.href = `detail?${e._id}`)}
              >
                <div
                  className="homeCard2Top"
                  style={{
                    backgroundImage: `url(${e.image[0].zurag0})`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                ...
                <div className="homeCard2Under">
                  <div className="homeCard2UnderText1">
                    Well Furnished {e?.Placetype}
                  </div>
                  <div className="homeCard2UnderText2">
                    100 Smart Street, LA, USA{" "}
                  </div>
                </div>
              </div>
