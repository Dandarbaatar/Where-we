    ...
    <div className='Footer_container'>
      <div className='Footer_container_small'>
        <div className='Footer_first'>
          ...
          <div style={{width:"15vw",fontFamily: 'Montserrat',
              fontStyle: "normal",
              fontWeight: "500",
              fontSize: "16px",
              lineHeight: "30px",
          ...
          <div style={{width:"16vw",display:"flex",justifyContent:"space-between"}}>
            <button className='Footer_buttons' ><img src={playstore} alt="" /> PlayStore</button>
            <button className='Footer_buttons' ><img src={applestore} alt="" /> AppleStore</button>
          </div>
        </div>
        ...
        <div className='Footer_four'>
          ...
          <div style={{width:"7vw",display:"flex",justifyContent:"space-between"}}>
