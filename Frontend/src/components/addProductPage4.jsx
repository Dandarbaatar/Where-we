...
function AddProductPage4() {
  ...
  <div className='host_add_container'>
        <div className='host_add_container_l'>  
            <div className='host_add_question'>Add saftey available at your place.</div>
            <div className='host_add_checkbox_father'>
                <div style={{display:"flex",flexDirection:"row"}}>
                <input type="checkbox" value="sanitizers" onChange={handlechange}  />
                <div className='host_add_answer'>sanitizers</div>
                </div>
                <div style={{display:"flex",flexDirection:"row"}}>
                <input  type="checkbox" value="fire throwers"  onChange={handlechange} />
                <div className='host_add_answer'>fire extinguishers</div>
                </div>
                <div style={{display:"flex",flexDirection:"row"}}>
                <input type="checkbox" value="daily cleaner"  onChange={handlechange} />
                <div className='host_add_answer'>daily cleaner</div>
                </div>
                <div style={{display:"flex",flexDirection:"row"}}>
                <input type="checkbox" value="fire detector"  onChange={handlechange} />
